...
class List:
    ...
    def append(self, value):
        ...
        -------------------------------------------------------
        """
        deepcop = deepcopy(value)
        self._values.append(deepcop)
    ...
    def clean(self):
        ...
        """
        alr = set()
        special = [x for x in self._values if not (x in alr or alr.add(x))]
        self._values = special
        return
    ...
    def insert(self, i, value):
        ...
        if -len(self._values) <= i or i <= len(self._values) - 1:
            self._values.insert(i, deepcop)
        elif i < -len(self._values):
            self._values.insert(0, deepcop)
        else:
            self._values.append(deepcop)
    ...
    def intersection(self, source1, source2):
        ...
        """
        self._values = []
        list1 = set(source1._values)
        list2 = set(source2._values)
    ...
    def max(self):
        ...
        maxim = self._values[0]
        for value in self._values[1:]:
            if value > maxim:
                maxim = value

        value = deepcopy(maxim)
        return value
    ...
    def min(self):
        ...
        minim = self._values[0]

        for value in self._values[1:]:
            if value < minim:
                minim = value

        value = deepcopy(minim)
        return value
    ...
    def split(self):
        ...
        target1 = List()
        target2 = List()
        target1._values, target2._values = self._values[:half], self._values
        self._values = []
