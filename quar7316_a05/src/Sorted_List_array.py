...
class Sorted_List:
    ...
    def __contains__(self, key):
        ...
        -------------------------------------------------------
        """
        start_index, end_index = 0, len(self._elements) - 1
        key_found = False

        while start_index <= end_index and not key_found:
            mid_index = (start_index + end_index) // 2
            if self._elements[mid_index] == key:
                key_found = True
            elif self._elements[mid_index] < key:
    ...
    def remove(self, key):
        ...
        while index < len(self._values) and value is None:
    ...
    def split(self):
        ...
        -------------------------------------------------------
        """
        halfway = len(self._values) // 2
        target1 = Sorted_List()
        target2 = Sorted_List()

        for i in self._values[halfway:]:
